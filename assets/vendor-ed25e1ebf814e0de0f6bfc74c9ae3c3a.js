...
var i=s(r,"errorFormat","MMM Do, YYYY"),c=a(r,["format","precision","allowBlank"]),d=c.format,p=c.precision,h=c.allowBlank,f=a(r,["before","onOrBefore","after","onOrAfter"]),m=f.before,y=f.onOrBefore,g=f.after,v=f.onOrAfter,b=void 0
if(h&&n(e))return!0
if(d){if(!(b=l(e,d,!0)).isValid())return(0,t.default)("wrongDateFormat",e,r)}else if(!(b=l(e)).isValid())return(0,t.default)("date",e,r)
if(m&&(m=l(m,d),!b.isBefore(m,p)))return o(r,"before",m.format(i)),(0,t.default)("before",e,r)
if(y&&(y=l(y,d),!b.isSameOrBefore(y,p)))return o(r,"onOrBefore",y.format(i)),(0,t.default)("onOrBefore",e,r)
if(g&&(g=l(g,d),!b.isAfter(g,p)))return o(r,"after",g.format(i)),(0,t.default)("after",e,r)
if(v&&(v=l(v,d),!b.isSameOrAfter(v,p)))return o(r,"onOrAfter",v.format(i)),(0,t.default)("onOrAfter",e,r)
